<footer class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 flex p-8 border-t">
    <svg class="h-6 w-auto mr-4" viewBox="0 0 91 27" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g fill="#7A7D85">
            <path
        ...
        <g fill="#7A7D85">
            <path
                d="m90.4 23.3c0 2.1-1.6 3.7-3.8 3.7s-3.8-1.6-3.8-3.7 1.6-3.7 3.8-3.7c2.2-.1 3.8 1.5 3.8 3.7zm-.7 0c0-1.8-1.3-3.1-3.1-3.1s-3.1 1.3-3.1 3.1 1.3 3.1 3.1 3.1 3.1-1.4 3.1-3.1zm-1.7.8.1.9h-.7l-.1-.9c0-.3-.2-.5-.5-.5h-.8v1.4h-.7v-3.5h1.4c.7 0 1.2.4 1.2 1.1 0 .4-.2.6-.5.8.4.1.5.3.6.7zm-1.9-1h.7c.4 0 .5-.3.5-.5 0-.3-.2-.5-.5-.5h-.7z"></path>
        </g>
    </svg>
